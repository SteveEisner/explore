...
slides = Tabs([{label: "01 · Explore", content: [s1]}, {label: "02 · The idea", content: [s2]}, {label: "03 · The plan", content: [s4]}, {label: "04 · How we build it", content: [s3]}], "proposal/slide", "deck-tabs")
