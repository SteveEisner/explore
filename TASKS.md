...
| Revisit: attach a screenshot to every voice turn so deictic references resolve visually | voice | parked idea; unblocked now that voice screenshots are downscaled to ~95KB for the data channel (2026-07-12 blitz) — weigh tokens/latency against the get_app_state-first guidance |
