...
| Teach the voice (front-end) agent to not announce what it's doing as much, if possible: less "I'll now…"/"let me…" narration for quick local actions — just do them; keep progress narration for long delegated work (voice-agent.md guidance tweak; balances against the phone-style delegation-narration guidance already there) | voice/prompts | from Steve 2026-07-12 |
