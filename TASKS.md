...
| 10. Live spoken validation: real mic in a real browser — speak, watch tools fire (state nav, wiki edit, screenshot, fast/smart delegation), edits land live, transcripts fold into the chat pane, idle auto-close after 2 min. Everything below the mic is covered by tests + a real session mint against OpenAI; the audio loop itself needs a human | J3 | — | todo |
